...
/**
 * A public document rendered from a Markdown file bundled at build time, so it
 * always matches the release: the user guide, the privacy policy. Prints
 * cleanly and needs no account.
 * @param {{ source: string, navLabel: string }} props
 */
export function MarkdownDoc({ source, navLabel }) {
