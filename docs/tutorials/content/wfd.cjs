  ...
  sections: [
    ...
    },
    {
      key: 'day', h: 'On the weekend', step: true, blocks: [
        ...
        { h2: 'Net control board and readiness', p: 'The captain keeps **Net control** open with the window set to Everything: who is on station at each position and who has not arrived, plus ICS 214 for the log. **Readiness** shows what is still open before the contest clock starts.' },
        { img: 'wfd-17-net-control', caption: 'Net control for the weekend, one line per position, worst first.' },
